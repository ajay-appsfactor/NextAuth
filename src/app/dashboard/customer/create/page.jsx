...
import addCustomerSchema from "@/validations/addCustomerSchema";
      ...
      return (
        ...
        <div className="mt-6 flex items-center">
          <button
            ...
            className="bg-gray-600 text-white text-sm px-4 py-2 cursor-pointer rounded-md hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
